...
$select = "SELECT * FROM $table_curtidas_comentarios_videos WHERE usuario=$cod_login && cod_comentario=$codigo_news ";
...
$inserir = "INSERT INTO $table_curtidas_comentarios_videos(usuario,cod_comentario,cod_usuario_comentario_curtido,data,hora) VALUES ($cod_login,$codigo_news,$cod_usuario_post, '$data', '$hora')";
$resultado_inserir = mysqli_query($mysqli, $inserir);

$atualizar = "UPDATE $table_comentario_video  SET curtidas = curtidas +1 WHERE codigo=$codigo_news";
