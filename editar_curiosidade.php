...
<?php
 ...
 $codigo_news = $_GET["codigo_news"];
            $consultar = "SELECT * FROM $table_curiosidades WHERE codigo=$codigo_news";
...
<table align="center">
    <form method="post" action="editar_curiosidade2.php" enctype="multipart/form-data" class="c-form">

 
  <tr>
                        
                        <td><input type="text" name="c_titulo" style="width:1000px;" placeholder="Título!" value="<?php print($vetor['titulo']); ?>" class="form-control"></td><br>
                  ...
                  <tr>
                        ...
                        <td><textarea rows="10" size="50" class="form-control" name="c_curiosidade" placeholder="Curiosidade!"><?php print($vetor['curiosidade']); ?></textarea></td><br>

                    </tr>
                      <input type="hidden" name= "cod_curiosidade" value="<?php print($vetor['codigo']); ?>">
