                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="add_curiosidade2.php" enctype="multipart/form-data" class="c-form">
  ...
  <tr>
                  ...
                  <tr>
                        ...
                        <td><textarea rows="10" size="50" class="form-control" name="c_curiosidade" placeholder="Curiosidade!"></textarea></td><br>
