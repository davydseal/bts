                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="mensagem_adm2.php" class="c-form">

 
<tr>
    <td>
                        <select class="form-control" style="width:700px;" name="c_enviar2">
                            <option value="">Para quem?</option>
                            <?php
             require("ligar.php");
                        
                        
                        $consulta_contatos = "SELECT * FROM $table_logins WHERE status=1 && codigo != $cod_login";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
$digitos_nome = strlen($vetor_amigo2[1]);
            ...
            ?>
                            ...
                            <option value="<?php print($vetor_contatos['nickname']); ?>"><?php print($vetor_amigo2[1]); ?> <?php print($vetor_amigo2[2]); ?></option>
    <?php
 }
 ?>             
                        </select></td><br>
                  ...
                  <tr>
                        ...
                        <td><textarea rows="10" size="50" class="form-control" name="c_texto" placeholder="Escreva a mensagem!"></textarea></td><br>

                    </tr>
                    <tr>
                        
                       <td><button type="submit" class="btn btn-solid">Enviar</button></td>
                   </tr>
                    </form>
</table>
