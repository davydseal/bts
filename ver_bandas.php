...
?>
 ...
 <?php
             require("ligar.php");
            $consulta3 = "SELECT * FROM $table_bandas WHERE status=1 order by nome ASC";
                                                ...
                                                <div class="profile-content">
                                                    <div class="image-section">
                                                        <div class="profile-img">
                                                            <div>
                                                                <img src="bandas/<?php print($variavel['img']); ?>"
                                                    ...
                                                    <div class="profile-detail">
                                                         <h2><?php print($variavel['nome']); ?> <span>❤</span></h2>
                                                            <h5><?php print($variavel['genero']); ?> </h5>
                                                      
                                                        <a href="add_banda.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-outline">Adicionar
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
