 ...
 <div id="load_data"></div><br>
  ...
  if($j >= 5)
            ...
            ?>
                                        <li>
                                            <div class="media">
                                                <a href="noticias2.php?codigo_news=<?php print($variavel['codigo']); ?>"><img class="img-fluid blur-up lazyload blur-up lazyload"
                                                        src="img/<?php print($variavel['img']); ?>"
                                                        alt="Generic placeholder image"></a>
                                                <div class="media-body align-self-center">
                                                    <div>
                                                        <a href="noticias2.php?codigo_news=<?php print($variavel['codigo']); ?>"><h5><i data-feather="heart" class="iw-12 ih-12"></i><?php print($variavel['titulo']); ?>
                                                        </h5></a>
