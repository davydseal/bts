...
?>
 ...
 <?php
             ...
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM logins WHERE status = 2 order by codigo desc";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
                                            ...
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <a href="ver_usuario_adm.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h2><?php print($vetor_amigo['nome']); ?> <?php print($vetor_amigo['sobrenome']); ?> <span>❤</span></h2></a>
                                                        <h5><?php print($vetor_amigo['email']); ?> </h5>
