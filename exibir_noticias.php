        ...
        <div class="page-center">
            ...
            ?>
                        <div class="element-item simulation" data-category="simulation">
                            <div class="game-box">
                                <div class="img-sec">
                                    <img src="img/<?php print($variavel['img']); ?>" class="img-fluid blur-up lazyload bg-img"
                                        alt="game">
                                    <a href="noticias_adm2.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Ver</a>
                                </div>
                                <div class="game-content">
                                    ...
                                    <a href="editar_noticia.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Editar</a>  <a href="excluir_noticia.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Excluir</a> 
                                </div>
                            </div>
                        </div>
                        <?php
