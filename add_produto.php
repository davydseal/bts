                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="add_produto2.php" enctype="multipart/form-data" class="c-form">
  ...
  <tr>
                   ...
                   <tr>
                        ...
                        <td><input type="text" name="c_qtd" placeholder="Quantidade!" class="form-control"></td><br>

                    </tr>
   <tr>
                        
                        <td><input type="text" name="c_preco" placeholder="Preço!" class="form-control"></td><br>
