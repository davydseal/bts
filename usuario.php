 ...
 <?php
  ...
  if($j >= 5)
            ...
            ?>
                                        ...
                                        <li>
                                            <div class="media">
                                                 <a title="" href="noticias_index2.php?codigo_news=<?php print($variavel['codigo']); ?>"><div class="img-part">
                                                ...
                                                <div class="media-body">
                                                   ...
                                                   <a title="" href="noticias_index2.php?codigo_news=<?php print($variavel['codigo']); ?>"> <h6><?php print($variavel['descricao']); ?></h6></a>
                        ...
                        <div class="create-post">
                            <div class="static-section">
                                ...
                                <div class="search-input input-style icon-right">
                                    <form method="post" action="publicar2_BUG.php" enctype="multipart/form-data">
                                   ...
                                   <input type="file" name="image[]" required multiple /><br>
                                    <center><button type="submit" name="submit" class="btn btn-solid">Publicar</button></center>
...
$quantidade_post = mysqli_num_rows($resultado_post);
     ...
     <ul id="counter">
                                             <li>
                                                ...
                                                <h3 class="counter-value"><?php print substr($vetor_contatos['exp'],0,1); ?></h3>
                                                <a href="seguindo.php"><h5>lvl</h5></a>
                                            </li>
...
$consultar_coment = "SELECT * FROM $table_comentario WHERE post=$vetor_contatos[0]";
$resultado_coment = mysqli_query($mysqli,$consultar_coment);
$vetor_coment = mysqli_fetch_array($resultado_coment);

$consultar_coment_l = "SELECT * FROM $table_logins WHERE codigo=$vetor_contatos[7]";
$resultado_coment_l = mysqli_query($mysqli,$consultar_coment_l);
$vetor_coment_l = mysqli_fetch_array($resultado_coment_l);

$consultar_coment_d = "SELECT * FROM $table_dados WHERE cod_login=$vetor_contatos[7]";
$resultado_coment_d = mysqli_query($mysqli,$consultar_coment_d);
$vetor_coment_d = mysqli_fetch_array($resultado_coment_d);
            ...
            <div class="post-wrapper col-grid-box">
                                <div class="post-title">
                                    <div class="profile">
                                        <div class="media">
                                            <a class="popover-cls user-img" data-bs-toggle="popover" href="ver_usuario.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>" data-placement="right"
                                                data-name="sufiya eliza" data-img="img/<?php print($vetor_amigo['foto']); ?>">
                                                <img src="img/<?php print($vetor_amigo['foto']); ?>"
                                                    class="img-fluid blur-up lazyload bg-img" alt="user">
                                            </a>
                                            <div class="media-body">
                                                 <a href="ver_usuario.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h5><?php print($vetor_amigo2['nome']); ?> <?php print($vetor_amigo2['sobrenome']); ?></h5></a>
                                    ...
                                    <div class="setting-btn ms-auto setting-dropdown no-bg">
                                        <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    <li>
                                                        <a href="denunciar.php?codigo_news=<?php print($vetor_contatos['codigo']); ?>&& cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>"><i class="icon-font-light iw-16 ih-16"
                                ...
                                <div class="post-details">
                                    ...
                                    <div class="detail-box">
                                        ...
                                        <p><?php print($vetor_contatos['post']); ?></p>
                                        ...
                                        <ul>
                                           <li class="react-btn">
                                            ...
                                            <li class="comment-click">
                                                <a href="ver_publicacao.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>">
                                                    <i class="iw-18 ih-18" data-feather="message-square"></i> Comentar
                                                </a>
                                            </li>
                                            <li>
                                                <a href="compartilhar_publicacao.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>">
                                    ...
                                    <div class="comment-section">
                                            ...
                                            <div class="main-comment">
                                                <div class="media">
                                                    <a href="#" class="user-img popover-cls" data-bs-toggle="popover"
                                                        ...
                                                        <img src="img/<?php print($vetor_coment_l['foto']); ?>"
                                                            class="img-fluid blur-up lazyload bg-img" alt="user">
                                                    </a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h5><?php print($vetor_coment_d['nome']); ?> <?php print($vetor_coment_d['sobrenome']); ?></h5>
                                                        </a>
                                                        <p><?php print($vetor_coment['comentario']); ?>
                                                          
                                                        </p>
                                                        <ul class="comment-option">
                                                            <li><a href="#">Gostei (<?php print($vetor_coment['curtidas']); ?>)</a></li>
                                                            <li><a href="#">reply</a></li>
                                                            <li><a href="#">translate</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="comment-time">
                                                        <h6><?php print($vetor_coment['data']); ?> ás <?php print($vetor_coment['hora']); ?></h6>
                                                    </div>
                                        ...
                                        <div class="reply">
                                            <div class="search-input input-style input-lg icon-right">
                                                <form method="post" action="comentario2.php">
<input type="hidden" name="c_post" value="<?php print($vetor_contatos['codigo']); ?>">
<input type="hidden" name="cod_usuario_post" value="<?php print($vetor_contatos['usuario']); ?>">
                                                <input type="text" name="c_comentario" class="form-control"
                                                    placeholder="Escreva um comentario.."><br><button type="submit" class="btn btn-solid">Comentar</button>
                                                    </form>
