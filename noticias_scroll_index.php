...
echo '
                                ...
                                <div class="blog-wrap">
                                    <div class="blog-image">
                                        <a href="noticias_index2.php?codigo_news='.$row["codigo"].'" data-tilt="" data-tilt-perspective="110" data-tilt-speed="400"
                                            data-tilt-max="1.2">
                                            <img src="img/'.$row["img"].'"
                                    ...
                                    <div class="blog-details">
                                        ...
                                        <a href="noticias_index2.php?codigo_news='.$row["codigo"].'">
                                            <h5>'.$row["titulo"].'</h5>
                                        </a>
                                        <p>'.$row["descricao"].'
                                        </p>
