...
$insert = "INSERT INTO $table_comentario(post, usuario, comentario, status, data, hora, cod_usuario_post) VALUES ('$c_post', $cod_login, '$c_comentario', 1, '$data', '$hora','$cod_usuario_post')";
