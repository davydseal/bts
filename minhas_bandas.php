...
$consultar_genero = "SELECT * FROM $table_bandas WHERE codigo=$var_amigo order by nome ASC";
                                            ...
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <h2><?php print($vetor_genero['nome']); ?> <span>❤</span></h2>
                                                           <h5><?php print($vetor_genero['genero']); ?> </h5>
                                                       
                                                     
                                                        <a href="remover_bandas.php?codigo_news=<?php print($vetor_genero['codigo']); ?>" class="btn btn-outline">Remover
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
