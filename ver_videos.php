...
$quantidade_post = mysqli_num_rows($resultado_post);
 ...
 ?>
                        ...
                        <div class="post-panel infinite-loader-sec section-t-space">
                             ...
                             <?php
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM $table_video order by codigo desc";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
$vetor_amigo2 = mysqli_fetch_array($resultado_amigo2);
  ...
  <source src="video/<?php print($vetor_contatos['img']); ?>" type="video/mp4"></video>
                                    </div>
                                    <div class="detail-box">
                                        <h3><?php print($vetor_contatos['descricao']); ?></h3>
                                   ...
                                   <div class="post-react">
                                        <ul>
                                            <li class="react-btn">
                                                <a href="curtida_video.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>" class="react-click">
                                                    <i class="iw-18 ih-18" data-feather="smile"></i> Gostei
                                                </a>
                                               
                                            </li>
                                            <li class="comment-click">
                                                <a href="ver_video_publicado.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>">
                                                    <i class="iw-18 ih-18" data-feather="message-square"></i> Comentar
                                                </a>
                                            </li>
                                            <li>
                                                <a href="compartilhar_video_publicado.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>">
