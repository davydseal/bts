...
$quantidade_seguidor = mysqli_num_rows($resultado_seguidor);
            ...
            <div class="profile-menu section-t-space">
                <ul>
                    ...
                    <li>
                        <a href="seguindo_usuario_adm.php?codigo_news=<?php print($vetor_login['codigo']); ?>">
                            <i class="iw-14 ih-14" data-feather="users"></i>
                            <h6>Seguindo</h6>
                        </a>
                    </li>
                     <li>
                        <a href="seguidores_usuario_adm.php?codigo_news=<?php print($vetor_login['codigo']); ?>">
                            <i class="iw-14 ih-14" data-feather="users"></i>
                            <h6>Seguidores</h6>
                        </a>
                    </li>
                    <li>
                        <a href="ver_fotos_usuario_adm.php?codigo_news=<?php print($vetor_login['codigo']); ?>">
            ...
            ?>
                                    <li>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a href="ver_usuario_adm.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h4> <span><?php print($vetor_amigo2[1]); ?> <?php print($vetor_amigo2[2]); ?></span></h4></a>
