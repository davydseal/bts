...
?>
 ...
 $codigo_news = $_GET["codigo_news"];
            $consultar = "SELECT * FROM $table_loja WHERE codigo=$codigo_news";
            ...
            ?>
<table align="center">
    <form method="post" action="editar_produto2.php" class="c-form">
...
?>
      ...
      <option value="1" checked>Produto Ativado</option>
      <option value="2">Produto Desativado</option>
      <?php
}
...
?>
      ...
      <option value="2" checked>Produto Desativado</option>
<option value="1">Produto Ativado</option>
<?php
}
 ?>
                                                    </select></td><br>
  ...
  <tr>
                     ...
                     <tr>
                        ...
                        <td><textarea rows="4" size="50" class="form-control" name="c_descricao" placeholder="Descrição!"><?php print($vetor['descricao']); ?></textarea></td><br>
                   ...
                   <tr>
                        ...
                        <td><input type="text" name="c_qtd" placeholder="Quantidade!" value="<?php print($vetor['qtd']); ?>" class="form-control"></td><br>

                    </tr>
   <tr>
                        
                        <td><input type="text" name="c_preco" placeholder="Preço!" value="<?php print($vetor['preco']); ?>" class="form-control"></td><br>

                    </tr>

                     <input type="hidden" name= "cod_produto" value="<?php print($vetor['codigo']); ?>">
                    <tr>
