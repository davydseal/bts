...
?>
    ...
    <div class="page-body container-fluid custom-padding profile-page profile-page-friend">
        ...
        <div class="page-center">
                                        ...
                                        <div class="row gallery-album">
                                             <div class="col-xl-3 col-lg-4 col-6">
                                                <div class="card add-card">
                                                    <div class="add-icon">
                                                        <div>
                                                            <a href="add_produto.php"><i class="iw-30 ih-30" data-feather="plus-circle"></i></a>
                                                            <input type="file" class="form-control-file">
                                                            <h5 class="card-title">Novo Produto</h5>
                                                            <p>Adicionar novo produto na loja</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
             require("ligar.php");
            $consulta3 = "SELECT * FROM $table_loja";
            ...
            ?>
                                            <div class="col-xl-3 col-lg-4 col-6">
                                                <a href="ver_produto_adm.php?codigo_news=<?php print($variavel['codigo']); ?>" class="card collection">
                                                 ...
                                                 <center><a href="editar_produto.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Editar</a>
                                                <a href="excluir_produto.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Excluir</a></center>
                                            </div>
