...
$select = "SELECT * FROM $table_report_video WHERE id_reportador=$cod_login && id_post=$codigo_news ";
...
$inserir = "INSERT INTO $table_report_video(id_post,id_reportador, data, hora,id_usuario_reportado) VALUES ($codigo_news,$cod_login, '$data', '$hora',$cod_usuario_post)";
