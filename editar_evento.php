...
<?php
 ...
 $codigo_news = $_GET["codigo_news"];
            $consultar = "SELECT * FROM $table_evento WHERE codigo=$codigo_news";
            ...
            ?>
<table align="center">
    <form method="post" action="editar_evento2.php" class="c-form">

  <tr>
                        
                        <td> <select name="c_status" class="form-control">
                                                        <?php
...
?>
      ...
      <option value="1" checked>Evento Ativado</option>
      <option value="2">Evento Desativado</option>
      <?php
}
 else if($vetor['status'] == '2')
{
?>

      <option value="2" checked>Evento Desativado</option>
<option value="1">Evento Ativado</option>
<?php
}
 ?>
                                                    </select></td><br>
                     ...
                     <tr>
                        ...
                        <td> <input type="text" name="c_nome" style="width:1000px;" placeholder="Nome!" value="<?php print($vetor['nome']); ?>" class="form-control"></td><br>
                  ...
                  <tr>
                        ...
                        <td> <textarea cols="53" name="c_descricao" placeholder="Descrição!" rows="6" class="form-control"><?php print($vetor['descricao']);?></textarea></td><br>

                    </tr>
                     <tr>
                        
                        <td>   <textarea cols="53" name="c_regras" placeholder="Regras!" rows="10" class="form-control"><?php print($vetor['regras']); ?></textarea></td><br>

                    </tr>
                         <tr>
                        
                        <td>    <textarea cols="53" name="c_premiacao" placeholder="Premiação!" rows="4" class="form-control"><?php print($vetor['premiacao']); ?></textarea></td><br>

                    </tr>

                     <tr>
                        
                        <td>     <input type="text" placeholder="Início, Ex: dd/mm/aaaa" value="<?php print($vetor['datain']); ?>" id="outra_data" maxlength="10" onkeypress="mascaraData(this)" name="c_datain" class="form-control"></td><br>

                    </tr>

                     <tr>
                        
                        <td>    <input type="text" placeholder="Fim, Ex: dd/mm/aaaa" value="<?php print($vetor['datafim']); ?>" id="outra_data" maxlength="10" onkeypress="mascaraData(this)"s name="c_datafim" class="form-control"><br>

                    </tr>

                    <input type="hidden" name= "cod_evento" value="<?php print($vetor['codigo']); ?>">
                    <tr>
                        
                       <td><button type="submit" class="btn btn-solid">Editar</button></td>
                   </tr>
                    </form>
</table>
