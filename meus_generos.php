                                            ...
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <h2><?php print($vetor_genero['genero']); ?> <span>❤</span></h2>
                                                       
                                                     
                                                        <a href="remover_generos.php?codigo_news=<?php print($vetor_genero['codigo']); ?>" class="btn btn-outline">Remover
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
