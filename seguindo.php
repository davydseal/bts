                                        ...
                                        <li>
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <a href="ver_usuario.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h2><?php print($vetor_amigo2[1]); ?> <?php print($vetor_amigo2[2]); ?> <span>❤</span></h2></a>
                                                        ...
                                                        <a href="deixar_de_seguir.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>" class="btn btn-outline">Deixar de Seguir
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
