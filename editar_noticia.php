...
<?php
 ...
 $codigo_news = $_GET["codigo_news"];
            $consultar = "SELECT * FROM $table_noticias WHERE codigo=$codigo_news";
...
<table align="center">
    <form method="post" action="editar_noticia2.php" class="c-form">
  ...
  <tr>
                  ...
                  <tr>
                        ...
                        <td><textarea rows="10" size="50" class="form-control" name="c_noticia" placeholder="Notícia!"><?php print($vetor['noticia']); ?></textarea></td><br>

                    </tr>
                      <input type="hidden" name= "cod_noticia" value="<?php print($vetor['codigo']); ?>">
