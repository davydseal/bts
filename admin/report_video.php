          ...
          <!-- START CONTAINER FLUID -->
            ...
            <div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">Denúncias
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table class="table table-hover" id="basicTable">
                    <thead>
                      <tr>
                        ...
                        <th style="width:20%">Denunciado</th>
                        
                        <th style="width:15%">Data</th>
                        <th style="width:15%">Hora</th>
                        <th style="width:15%">Excluir</th>
                        <th style="width:15%">Manter</th>
                      </tr>
                    </thead>
                            <?php
             require("../ligar.php");
            $consulta_contatos = "SELECT * FROM $table_report_video order by codigo desc";
...
$consultar_amigo3 = "SELECT * FROM $table_video WHERE codigo=$var_amigo";
$resultado_amigo3 = mysqli_query($mysqli,$consultar_amigo3);
$vetor_amigo3 = mysqli_fetch_array($resultado_amigo3);



if($verificadora_amigos > 4)
{
break;
}
 ?>
                    <tbody>
                        ...
                        <td class="v-align-middle ">
                          <p><video width="200" height="150" controls>
  <source src="../video/<?php print($vetor_amigo3['img']); ?>" type="video/mp4">

</video></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($vetor_amigo3['descricao']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($vetor_amigo3['nickname']); ?></p>
                        </td>
                       
                        <td class="v-align-middle">
                          <p><?php print($vetor_contatos['data']); ?></p>
                        </td>
                         <td class="v-align-middle">
                          <p><?php print($vetor_contatos['hora']); ?></p>
                        </td>
                         <td class="v-align-middle">
                          <p><a href="excluir_video.php?codigo_news=<?php print($vetor_amigo3['codigo']); ?>">Excluir</a></p>
                        </td>
                         <td class="v-align-middle">
                          <p><a href="manter_video.php?codigo_news=<?php print($vetor_amigo3['codigo']); ?>">Manter</a></p>
                        </td>
                      </tr>
