        ...
        <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    <h4>Cadastro de curiosidades</h4>

                    <form name="f" action="cadastrar_curiosidades2.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                       ...
                       <textarea cols="53" name="c_curiosidade" rows="10" class="md-input"></textarea>
                      </div>
