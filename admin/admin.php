...
<!-- Mirrored from pages.revox.io/dashboard/latest/html/simply_white/default_layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 May 2021 13:45:38 GMT -->
  ...
  <body class="fixed-header menu-pin">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          <li class="m-t-10">
            <a href="admin.php" class="detailed">
          ...
          <li class="">
            <a href="contato.php" class="detailed">
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="cadastrar_admin.php">Administrador</a>
              </li>
               <li class="">
                <a href="cadastrar_fotos_index.php">Fotos na tela inicial</a>
              </li>
              <li class="">
                <a href="cadastrar_noticia.php">Notícia</a>
              </li>
              <li class="">
                <a href="cadastrar_curiosidades.php">Curiosidades</a>
              </li>
              <li class="">
                <a href="cadastrar_genero.php">Gêneros musicais</a>
              </li>
               <li class="">
                <a href="cadastrar_banda.php">Bandas</a>
              </li>
              <li class="">
                <a href="cadastrar_produtos.php">Produtos</a>
              </li>
               <li class="">
                <a href="cadastrar_evento.php">Evento</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="consultar_admin.php">Administrador</a>
              </li>
              <li class="">
                <a href="consultar_noticia.php">Notícia</a>
              </li>
               <li class="">
                <a href="consultar_curiosidade.php">Curiosidade</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="javascript:;">
              <span class="title">Denuncia</span>
              <span class=" arrow"></span>
            </a>
           <span class="icon-thumbnail"><i data-feather="shield"></i></span>
            <ul class="sub-menu">
               <li class="">
                <a href="consultar_denuncias.php">Publicações</a>
              </li>
               
               <li class="">
                <a href="report_video.php">Videos</a>
              </li>
          ...
          <li>
            ...
            <ul class="sub-menu">
              ...
              <li class="">
                <a href="form_layouts.html">Notícia</a>
              </li>
            </ul>
          </li>
          <li>
      ...
      <div class="header ">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="pull-left p-r-10 fs-14 d-lg-inline-block d-none m-l-20">
            <?php
       require("../ligar.php");
$consulta_foto = "SELECT * FROM $table_logins WHERE codigo=$codigo";
$resultado_foto = mysqli_query($mysqli, $consulta_foto);
$vetor_foto = mysqli_fetch_array($resultado_foto);
?>
            <span class="semi-bold"><?php print($vetor_foto['nickname']); ?></span>
          </div>
...
$vetor_foto = mysqli_fetch_array($resultado_foto);
?>
              <a href="#" class="dropdown-item"><span>Signed in as <br /><b><?php print($vetor_foto['nickname']); ?></b></span></a>
...
$consulta_noticia = "SELECT * FROM $table_noticias";
$resultado_noticia = mysqli_query($mysqli,$consulta_noticia);
$quantidade_noticia = mysqli_num_rows($resultado_noticia);

                  ?>

                   <?php

$consulta_curiosidade= "SELECT * FROM $table_curiosidades";
$resultado_curiosidade = mysqli_query($mysqli,$consulta_curiosidade);
$quantidade_curiosidade = mysqli_num_rows($resultado_curiosidade);
...
$consulta_video= "SELECT * FROM $table_video";
$resultado_video = mysqli_query($mysqli,$consulta_video);
$quantidade_video = mysqli_num_rows($resultado_video);

                  ?>

<div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">Indicadores
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-6 sortable-column">
                    <div class="card card-default bg-complete" data-pages="card">
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_usuario); ?></span></h3>
                      
                      </div>
                    </div>
                    <div class="card card-default bg-complete" data-pages="card">
                      <div class="card-header ">
                        <div class="card-title">Administradores
                        </div>
                        <div class="card-controls">
                          <ul>
                            <li><a href="#" class="card-collapse" data-toggle="collapse"><i
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_admin); ?></span></h3>
                      
                      </div>
                    </div>
                    <div class="card card-default bg-complete" data-pages="card">
                      <div class="card-header ">
                        <div class="card-title">Publicações
                        </div>
                        <div class="card-controls">
                          <ul>
                            <li><a href="#" class="card-collapse" data-toggle="collapse"><i
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_public); ?></span></h3>
                  ...
                  <div class="col-lg-6 sortable-column">
                     <div class="card card-default bg-complete" data-pages="card">
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_noticia); ?></span></h3>
                        
                      </div>
                    </div>
                     <div class="card card-default bg-complete" data-pages="card">
                      <div class="card-header ">
                        <div class="card-title">Curiosidades
                        </div>
                        <div class="card-controls">
                          <ul>
                            <li><a href="#" class="card-collapse " data-toggle="collapse"><i
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_curiosidade); ?></span></h3>
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_video); ?></span></h3>
...
<div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">Denuncias
                </div>
              </div>
              <div class="card-body sortable">
                <div class="row">
                  <div class="col-lg-6 sortable-column">
                    <div class="card card-default bg-danger" data-pages="card">
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_report_public); ?></span></h3>
                  ...
                  <div class="col-lg-6 sortable-column">
                      ...
                      <div class="card-body">
                        <h3>
                <span class="semi-bold"><?php print($quantidade_report_video); ?></span></h3>
