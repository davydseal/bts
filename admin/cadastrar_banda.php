          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    ...
                    <form name="f" action="cadastrar_banda2.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label>Gênero</label>
                         ...
                         <select name="c_genero" class="form-control">
                         
                          <option value="">Selecione</option>
                            <?php
                     require("../ligar.php");

$tipo_news = "SELECT * FROM $table_generos_musicais";
...
?> 
                            <option value="<?php print($vetor_news['genero']);?>"><?php print($vetor_news['genero']);?></option>
     <?php
}
