          ...
          <!-- START CONTAINER FLUID -->
            ...
            <div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">Consultar Curiosidade
                </div>
              </div>
              <div class="card-body">
                      ...
                      <tr>
                        ...
                        <th style="width:15%">Data</th>
                         <th style="width:15%">Hora</th>
                          ...
                          <?php
             require("../ligar.php");
            $consulta3 = "SELECT * FROM $table_curiosidades WHERE status=1 order by codigo";
            ...
            ?>
                    <tbody>
                        ...
                        <td class="v-align-middle ">
                          <p><img src="../img/<?php print($variavel['img']); ?>" width="50" height="50"></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['titulo']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['curiosidade']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['status']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['data']); ?></p>
                        </td>
                         <td class="v-align-middle">
                          <p><?php print($variavel['hora']); ?></p>
                        </td>
                      </tr>
