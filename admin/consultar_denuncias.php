                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:15%">Manter</th>
                            ...
                            <?php
             require("../ligar.php");
            $consulta_contatos = "SELECT * FROM $table_report order by codigo desc";
...
$consultar_amigo3 = "SELECT * FROM $table_post WHERE codigo=$var_amigo";
 ...
 ?>
                    <tbody>
                        ...
                        <td class="v-align-middle ">
                          <p><img src="../img/<?php print($vetor_amigo3['img']); ?>" width="50" height="50"></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($vetor_amigo3['post']); ?></p>
                        </td>
                        <td class="v-align-middle">
                        ...
                        <td class="v-align-middle">
                         ...
                         <td class="v-align-middle">
                          <p><a href="excluir_denuncia.php?codigo_news=<?php print($vetor_amigo3['codigo']); ?>">Excluir</a></p>
                        </td>
                         <td class="v-align-middle">
                          <p><a href="manter_publicacao.php?codigo_news=<?php print($vetor_amigo3['codigo']); ?>">Manter</a></p>
                        </td>
                      </tr>
