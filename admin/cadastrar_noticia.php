          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    ...
                    <form name="f" action="cadastrar_noticia2.php" method="post" enctype="multipart/form-data">
                    
                      
                      
                      <div class="form-group">
                        <label>Título</label>
                        <input type="text" name="c_titulo" class="form-control">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Notícia</label>
                       <textarea cols="53" name="c_noticia" rows="10" class="md-input"></textarea>
                      </div>
