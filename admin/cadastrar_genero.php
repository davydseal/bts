        ...
        <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    <h4>Cadastro de gêneros musicais</h4>

                    <form name="f" action="cadastrar_genero2.php" method="post" enctype="multipart/form-data">
                    
                      
                      
                      <div class="form-group">
                        <label>Título</label>
                        <input type="text" name="c_genero" class="form-control">
                      </div>
