...
?>
          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    ...
                    <form name="f" action="cadastrar_admin2.php" method="post">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group form-group-default">
                            ...
                            <input type="text" name="c_sobrenome" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Dia</label>
                        <input type="text" name="c_dia" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>Mês</label>
                        <select name="c_mes" id="select_demo_2" class="form-control" >
      ...
      <option value="12">Dezembro</option>
                      ...
                      <div class="form-group">
                        <label>Ano</label>
                        <input type="text" name="c_ano" class="form-control">
                      </div>
                     <div class="form-group">
                        <label>Email</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="c_endereco" class="form-control">
                      </div>
<div class="form-group">
                        <label>Gênero</label><br>
                        Masculino <input type="radio" name="c_sexo" value="M" id="radio_demo_inline_1" data-md-icheck />
                        Fêminino <input type="radio" name="c_sexo" value="F" id="radio_demo_inline_2" data-md-icheck />
                      </div>
                      <div class="form-group">
                        <label>Login</label>
                        <input type="text" name="c_nickname" class="form-control">
                      </div>
                      <div class="form-group">
                        <label>Senha</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" name="c_senha2" class="form-control">
                      </div>
