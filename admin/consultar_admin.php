          ...
          <!-- START CONTAINER FLUID -->
            ...
            <div class="card card-transparent">
              <div class="card-header ">
                <div class="card-title">Consultar Administrador
                </div>
              </div>
              <div class="card-body">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:20%">Email</th>
                          ...
                          <?php
             require("../ligar.php");
            $consulta3 = "SELECT * FROM $table_dados order by codigo";
            ...
            ?>
                    <tbody>
                        ...
                        <td class="v-align-middle">
                          <p><?php print($variavel['nome']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['sobrenome']); ?></p>
                        </td>
                        <td class="v-align-middle">
                          <p><?php print($variavel['email']); ?></p>
                        </td>
