        ...
        <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                 ...
                 <form method="post" action="cadastrar_evento2.php" enctype="multipart/form-data">
                    
                      
                      
                      <div class="form-group">
                        <label>Nome</label>
                        <input type="text" name="c_nome" class="form-control">
                      </div>
           
                       <div class="form-group">
                        <label>Descrição</label>
                       <textarea cols="53" name="c_descricao" rows="6" class="form-control"></textarea>
                      </div>
                      <div class="form-group">
                        <label>Regras</label>
                       <textarea cols="53" name="c_regras" rows="10" class="form-control"></textarea>
                      </div>
                       <div class="form-group">
                        <label>Premiação</label>
                       <textarea cols="53" name="c_premiacao" rows="4" class="form-control"></textarea>
                      </div>
                       <div class="form-group">
                        <label>Data do inicio</label>
                        <input type="text" placeholder="Ex: dd/mm/aaaa" id="outra_data" maxlength="10" onkeypress="mascaraData(this)" name="c_datain" class="form-control">

                       
                      </div>
                       <div class="form-group">
                        <label>Data do Fim</label>
                        <input type="text" placeholder="Ex: dd/mm/aaaa" id="outra_data" maxlength="10" onkeypress="mascaraData(this)"s name="c_datafim" class="form-control">
             
                      </div>

<br>
 <input type="file" name="arquivo" id="arquivo">
                                <input type="submit" name="butao" value="Postar">
