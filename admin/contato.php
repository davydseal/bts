...
?>
              ...
              <a href="sair.php" class="dropdown-item">Logout</a>
              <div class="dropdown-divider"></div>
          ...
          <!-- START CONTAINER FLUID -->
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:15%">Comentario</th>
                          ...
                          <?php
             require("../ligar.php");
            $consulta3 = "SELECT * FROM $table_contato order by codigo";
            ...
            ?>
                    <tbody>
                        ...
                        <td class="v-align-middle">
                          <p><?php print($variavel['comentario']); ?></p>
                        </td>
