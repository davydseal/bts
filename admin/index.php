...
<!-- Mirrored from pages.revox.io/dashboard/latest/html/simply_white/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 May 2021 13:46:29 GMT -->
    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 p-r-50 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <h2 class="p-t-25">Admin <br/></h2>
          <p class="mw-80 m-t-5">Login</p>
          <!-- START Login Form -->
         <form action="verifica_login.php" method="post">
            ...
            <div class="form-group form-group-default">
              <label>Login</label>
              <div class="controls">
                <input type="text" name="c_nickname" placeholder="User Name" class="form-control" required>
              </div>
            </div>
            <!-- END Form Control-->
            <!-- START Form Control-->
            <div class="form-group form-group-default">
              <label>Senha</label>
              <div class="controls">
                <input type="password" class="form-control" name="c_senha" placeholder="Credentials" required>
              </div>
            </div>
            <!-- START Form Control-->
            <div class="row">
