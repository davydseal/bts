...
?>
        ...
        <div class="content ">
          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    <h4>Cadastro de fotos na tela inicial</h4>

                    <form name="f" action="cadastrar_fotos_index2.php" method="post" enctype="multipart/form-data">
 ...
 <input type="file" name="Arquivo" id="Arquivo">
                                <input type="submit" name="butao" value="Publicar">
