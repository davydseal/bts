          ...
          <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    ...
                    <form name="f" action="cadastrar_produtos2.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="c_descricao" class="form-control">
                      </div>

                      <div class="form-group">
                        <label>Quantidade</label>
                        <input type="text" name="c_qtd" class="form-control">
                      </div>

                       <div class="form-group">
                        <label>Preço</label>
                        <input type="text" name="c_preco" class="form-control">
                      </div>
