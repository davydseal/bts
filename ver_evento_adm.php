                            ...
                            <div class="about-content">
                                <ul>
                                    <li>
                                        ...
                                        <div class="details">
                                            <h5>Nome</h5>
                                            <h6><?php print($vetor_eve['nome']); ?></h6>
                                        </div>
                                    </li>
                                     <li>
                                        <div class="icon">
                            ...
                            <div class="post-wrapper">
                                ...
                                <div class="post-details">
                                    ...
                                    <div class="post-react">
                                        <ul>
                                            <li class="react-btn">
                                                <a href="excluir_post_adm.php?codigo_news=<?php print($vetor_news['codigo']); ?>" class="react-click">
                                                    <i class="iw-18 ih-18" data-feather="smile"></i> Excluir
                                                </a>
