...
$consultar_amigo3 = "SELECT * FROM $table_post WHERE codigo=$vetor_contatos[1]";
                         ...
                         <div class="post-wrapper col-grid-box section-t-space">
                                        ...
                                        <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                  ...
                                                  <li>
                                                        <a href="manter_publicacao.php?codigo_news=<?php print($vetor_contatos['codigo']); ?>"><i class="icon-font-light iw-16 ih-16"
                                                                data-feather="bookmark"></i>Manter post</a>
                                                    </li>
                                                    <li>
                                                        <a href="excluir_post_report_adm.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['id_post']); ?>"><i class="icon-font-light iw-16 ih-16"
                                ...
                                <div class="post-details">
                                    <div class="img-wrapper">
                                        <img src="img/<?php print($vetor_amigo3['img']); ?>" class="img-fluid blur-up lazyload"
                                            alt="">
                                    </div>
                                    <div class="detail-box">
                                        <h3><?php print($vetor_amigo3['post']); ?></h3>
