                            ...
                            <div class="profile-content">
                                ...
                                <div class="profile-detail">
                                    ...
                                    <div class="counter-stats">
                                        <ul id="counter">
                                             <li>
                                                <h3 class="counter-value"><?php print($vetor['lvl']); ?></h3>
...
$quantidade_post = mysqli_num_rows($resultado_post);
 ...
 ?>
        ...
        $tipo_news = "SELECT post.codigo,post.usuario as post_usuario,post.img,post.post,post.nickname,post.status,post.data,post.hora,post.curtidas,  post.compartilhamentos, post.comentarios,
        contatos.amigo, contatos.usuario as cont_usuario,logins.foto from logins, post
LEFT JOIN contatos ON post.usuario = contatos.amigo
WHERE (logins.codigo = post.usuario ) and (post.usuario = $cod_login or contatos.usuario = $cod_login) && evento = 0
...
?>
                         ...
                         <div class="post-wrapper col-grid-box section-t-space">
                                        ...
                                        <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="denunciar.php?codigo_news=<?php print($vetor_news['codigo']); ?>&& cod_usuario_post=<?php print($vetor_news['post_usuario']); ?>"><i class="icon-font-light iw-16 ih-16"
                                ...
                                <div class="post-details">
                                    <a href="ver_publicacao.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['post_usuario']); ?>"><div class="img-wrapper">
                                        <img src="img/<?php print($vetor_news['img']); ?>" class="img-fluid blur-up lazyload"
                                            alt="">
                                    </div></a>
                                    <div class="detail-box">
                                        <h3><?php print($vetor_news['post']); ?></h3>
                                    ...
                                    <div class="post-react">
                                        <ul>
                                            <li class="react-btn">
                                                <a href="curtida.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['post_usuario']); ?>" class="react-click">
                                                    <i class="iw-18 ih-18" data-feather="smile"></i> Gostei
                                                </a>
                                               
                                            </li>
                                            <li class="comment-click">
                                                <a href="ver_publicacao.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['post_usuario']); ?>">
                                                    <i class="iw-18 ih-18" data-feather="message-square"></i> Comentar
                                                </a>
                                            </li>
                                            <li>
                                                <a href="compartilhar_publicacao.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['post_usuario']); ?>">
