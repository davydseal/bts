...
$select = "SELECT * FROM $table_curtidas_video WHERE cod_usuario=$cod_login && cod_post=$codigo_news ";
...
$inserir = "INSERT INTO $table_curtidas_video(cod_post,cod_usuario,cod_usuario_post) VALUES ($codigo_news,$cod_login,$cod_usuario_post)";
$resultado_inserir = mysqli_query($mysqli, $inserir);

$atualizar = "UPDATE $table_video  SET curtidas = curtidas +1 WHERE codigo=$codigo_news";
