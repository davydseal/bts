...
?>    
  ...
  <source src="video/<?php print($vetor_news['img']); ?>" type="video/mp4"></video>
                                    ...
                                    <div class="post-react">
                                        <ul>
                                            <li class="react-btn">
                                                <a href="curtida_video.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['usuario']); ?>" class="react-click">
 ...
 <div class="reply">
                                            <div class="search-input input-style input-lg icon-right">
                                                    <form method="post" action="comentario_video.php">
...
<input type="hidden" name="cod_usuario_post" value="<?php print($vetor_news['usuario']); ?>">
                                                <input type="text" name="c_comentario" class="form-control emojiPicker"
                                                    placeholder="Escreva um comentario.."><br>
                                                    <center><button type="submit" class="btn btn-solid">Comentar</button></center>
                                                    </form>
...
<?php
   $codigo_news = $_GET["codigo_news"];
             ...
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM $table_comentario_video WHERE post=$codigo_news order by codigo desc";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <ul class="comment-option">
                                                            <li><a href="curtida_comentario_video.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['usuario']); ?>">Gostei (<?php print($vetor_contatos['curtidas']); ?>)</a></li>
                                                           
 <li><a href="excluir_comentario_video.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && codigo_post=<?php print($vetor_news['codigo']); ?>">Excluir</a></li>
