                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="mensagem2.php" class="c-form">
...
$digitos_nome = strlen($vetor_amigo2[1]);
            ...
            ?>
                            ...
                            <option value="<?php print($vetor_amigo['nickname']); ?>"><?php print($vetor_amigo2[1]); ?> <?php print($vetor_amigo2[2]); ?></option>
    <?php
 }
 ?>             
                        </select></td><br>
