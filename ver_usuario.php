...
$inserir = "INSERT INTO $table_visitas(id_usuario,visitou) VALUES ($cod_login,$codigo_news)";
...
$quantidade_seguidor = mysqli_num_rows($resultado_seguidor);
            ...
            <div class="profile-menu section-t-space">
                ...
                <ul class="right-menu d-xl-flex d-none">
                      ...
                      <li>
                        <a href="add.php?codigo_news=<?php print($vetor_login['codigo']); ?>" title="Seguir">
                            <i data-feather="user-check" class="me-0 iw-14 ih-14"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i data-feather="message-square" class="me-0 iw-14 ih-14"></i>
                        </a>
                    </li>
                </ul>
            </div>
...
<div class="page-list section-t-space">
                                <div class="card-title">
                                    <a href="noticias.php"><h3>Gêneros Musicais</h3></a>
 ...
 <?php
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM $table_add_genero WHERE usuario=$codigo_news";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
$vetor_genero = mysqli_fetch_array($resultado_genero);
 ...
 <?php
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM $table_add_banda WHERE usuario=$codigo_news";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
$consultar_genero = "SELECT * FROM $table_bandas WHERE codigo=$var_amigo";
$resultado_genero = mysqli_query($mysqli,$consultar_genero);
$vetor_genero = mysqli_fetch_array($resultado_genero);
 ...
 if($i >= 5)
            ...
            ?>
                                        ...
                                        <li>
                                            <div class="media">
                                                <div class="img-part">
                                                     <img src="bandas/<?php print($vetor_genero['img']); ?>"
                                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                                </div>
                                                <div class="media-body">
                                                   <h4><?php print($vetor_genero['nome']); ?></h4>
 ...
 ?> 
                                        ...
                                        <div class=" btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="Seguindo_usuario.php?codigo_news=<?php print($vetor_login['codigo']); ?>"><i class="icon-font-light iw-16 ih-16"
             ...
             require("ligar.php");
                        ...
                        $consulta_contatos = "SELECT * FROM $table_contatos WHERE usuario=$codigo_news";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
if($vetor_contatos[2] == $codigo_news)
{
$var_amigo = ($vetor_contatos[1]);
}
else
...
$digitos_nome = strlen($vetor_amigo2[1]);
 ...
 ?> 
                                        ...
                                        <div class=" btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="Seguidores_usuario.php?codigo_news=<?php print($vetor_login['codigo']); ?>"><i class="icon-font-light iw-16 ih-16"
                                                                data-feather="search"></i>Ver Todos</a>
                                                    </li>
             ...
             require("ligar.php");
                        ...
                        $consulta_contatos = "SELECT * FROM $table_contatos WHERE amigo=$codigo_news";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
if($i >= 5)
 ...
 ?> 
                    ...
                    <div class="content-center">
                       ...
                       $consulta = "SELECT * FROM $table_logins WHERE codigo=$codigo_news && posts = 2";
...
?>
                       <?php
 echo "As publicações deste usuario estão privadas!";
  ?>
<?php
                       }
                       else
             ...
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM $table_post WHERE usuario=$codigo_news order by codigo desc";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
...
if($vetor_contatos[1] == $codigo_news)
{
$var_amigo = ($vetor_contatos[1]);
}
else
                                        ...
                                        <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="deixar_de_seguir2.php?codigo_news=<?php print($vetor_contatos['usuario']); ?>"><i class="icon-font-light iw-16 ih-16"
...
$consulta_foto = "SELECT * FROM $table_post WHERE usuario='$codigo_news' && foto=1";
                                        ...
                                        <div class="setting-btn ms-2 setting-dropdown">
                                            <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                    <ul>
                                                        <li>
                                                            <a href="ver_fotos_usuario.php?codigo_news=<?php print($vetor_login['codigo']); ?>"><i class="icon-font-light iw-16 ih-16"
