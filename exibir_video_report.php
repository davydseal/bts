...
$consultar_amigo3 = "SELECT * FROM $table_video WHERE codigo=$vetor_contatos[1]";
...
$vetor_amigo3 = mysqli_fetch_array($resultado_amigo3);
                                    ...
                                    <div class="profile">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <h6><?php print($vetor_amigo3['data']); ?> ás <?php print($vetor_amigo3['hora']); ?></h6>
                                            </div>
                                        ...
                                        <div class="btn-group custom-dropdown arrow-none dropdown-sm">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="manter_video.php?codigo_news=<?php print($vetor_contatos['codigo']); ?>"><i class="icon-font-light iw-16 ih-16"
                                                                data-feather="bookmark"></i>Manter post</a>
                                                    </li>
                                                    <li>
                                                        <a href="excluir_video_report_adm.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_post=<?php print($vetor_contatos['id_post']); ?>"><i class="icon-font-light iw-16 ih-16"
  ...
  <source src="video/<?php print($vetor_amigo3['img']); ?>" type="video/mp4"></video>
                                    </div>
                                    <div class="detail-box">
                                        <h3><?php print($vetor_amigo3['descricao']); ?></h3>
                                            ...
                                            <ul>
                                                <li>
                                                    <h5>
                                                        ...
                                                        <span><?php print($vetor_amigo3['curtidas']); ?></span> Curtidas
                                                    </h5>
                                                </li>
                                                <li>
                                                    <h5>
                                                        <i class="iw-16 ih-16" data-feather="message-square"></i>
                                                        <span><?php print($vetor_amigo3['comentarios']); ?></span> Comentarios
                                                    </h5>
                                                </li>
                                                <li>
                                                    <h5>
                                                        <i class="iw-16 ih-16" data-feather="share"></i><span><?php print($vetor_amigo3['compartilhamentos']); ?></span>
                                                        Compartilhamentos
                                                    </h5>
                                                </li>
                                            </ul>
