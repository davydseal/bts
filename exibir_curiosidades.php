   ...
   <!-- page body start -->
    <div class="page-body container-fluid custom-padding">
        ...
        <div class="page-center">
            ...
            ?>
                        <div class="element-item simulation" data-category="simulation">
                            <div class="game-box">
                                <div class="img-sec">
                                    <img src="curiosidade/<?php print($variavel['img']); ?>" class="img-fluid blur-up lazyload bg-img"
                                        alt="game">
                                    <a href="curiosidades_adm2.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Ver</a>
                                </div>
                                <div class="game-content">
                                    <h4><?php print($variavel['titulo']); ?></h4>
                                    <h5><?php print($variavel['descricao']); ?></h5>
                                    <p><?php print($variavel['view']); ?> visualizações, publicado dia <?php print($variavel['data']); ?> às <?php print($variavel['hora']); ?></p>
                                         <a href="editar_curiosidade.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Editar</a>  <a href="excluir_curiosidade.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Excluir</a> 
                                </div>
                            </div>
                        </div>
                        <?php
