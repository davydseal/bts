 ...
 <div id="load_data"></div><br>
  ...
  if($j >= 5)
            ...
            ?>
                                        <li>
                                            <div class="media">
                                                <a href="curiosidades_index2.php?codigo_news=<?php print($variavel['codigo']); ?>"><img class="img-fluid blur-up lazyload blur-up lazyload"
                                                        src="curiosidade/<?php print($variavel['img']); ?>"
                                                        alt="Generic placeholder image"></a>
                                                <div class="media-body align-self-center">
                                                    <div>
                                                        <a href="curiosidades_index2.php?codigo_news=<?php print($variavel['codigo']); ?>"><h5><i data-feather="heart" class="iw-12 ih-12"></i><?php print($variavel['titulo']); ?>
                                                        </h5></a>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"curiosidades_scroll_index.php",
   method:"POST",
