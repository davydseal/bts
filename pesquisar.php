...
?>
 ...
 <?php
             ...
             require("ligar.php");
                        $consulta_contatos = "SELECT * FROM dados WHERE nome LIKE '%$c_nickname%' && cod_login != $cod_login || sobrenome LIKE '%$c_nickname%' && cod_login != $cod_login";
                        $resultado_contatos = mysqli_query($mysqli,$consulta_contatos);
                        $quantidade_contatos = mysqli_num_rows($resultado_contatos);
                                            ...
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <a href="ver_usuario.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h2><?php print($vetor_contatos['nome']); ?> <?php print($vetor_contatos['sobrenome']); ?> <span>❤</span></h2></a>
                                                        <h5><?php print($vetor_contatos['email']); ?> </h5>
                                                        <div class="counter-stats">
                                                             <ul id="counter">
                                             <li>

                                               
                                                <h3 class="counter-value"><?php print substr($vetor_amigo['exp'],0,1); ?></h3>
                                                <a href="seguindo.php"><h5>lvl</h5></a>
                                                        ...
                                                        <a href="add.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>" class="btn btn-outline">Seguir
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
