...
$consulta_eve = "SELECT * FROM $table_evento WHERE codigo=$codigo_news";
$resultado_eve = mysqli_query($mysqli, $consulta_eve);
$vetor_eve = mysqli_fetch_array($resultado_eve);

?>
                 <!--  event cover start -->
            <div class="event-cover">
                <div class="event-img">
                    <img src="evento/<?php print($vetor_eve['img']); ?>" class="img-fluid blur-up lazyload bg-img" alt="">
                    <div class="event-content">
                        <h1><?php print($vetor_eve['nome']); ?></h1>
                    </div>
                    <div class="cover-img-detail">
                         <h3>Periodo do evento</h3>
                        <span><?php print($vetor_eve['datain']); ?> há <?php print($vetor_eve['datafim']); ?></span>
                            ...
                            <div class="about-content">
                                <ul>
                                     ...
                                     <li>
                                        ...
                                        <div class="details">
                                            <h5>Descrição</h5>
                                            <h6><?php print($vetor_eve['descricao']); ?></h6>
                                        </div>
                                    </li>
                                     <li>
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            <h5>Regras</h5>
                                            <h6><?php print($vetor_eve['regras']); ?></h6>
                                        </div>
                                    </li>
                                     <li>
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            <h5>Premiação</h5>
                                            <h6><?php print($vetor_eve['premiacao']); ?></h6>
                                        </div>
                                    </li>
                                     <li>
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            ...
                                            <h6><?php print($vetor_eve['datain']); ?></h6>
                                        </div>
                                    </li>
                                     <li>
                                        <div class="icon">
                                        ...
                                        <div class="details">
                                            <h5>Data do fim</h5>
                                            <h6><?php print($vetor_eve['datafim']); ?></h6>
                                        </div>
                                    </li>
 ...
 <div class="reply">
                                            <div class="search-input input-style input-lg icon-right">
                                                    <form method="post" action="publicar_evento.php" enctype="multipart/form-data">
<input type="hidden" name="c_cod_eve" value="<?php print($vetor_eve['codigo']); ?>">
                                                <textarea rows="7" name="c_descricao" class="form-control enable" placeholder="Descrição.."></textarea><br>
...
$tipo_news = "SELECT * FROM $table_post WHERE evento=1 && cod_evento=$cod_evento order by codigo desc";
                                ...
                                <div class="post-details">
                                    ...
                                    <div class="post-react">
                                        <ul>
                                            ...
                                            <li >
                                                <a href="compartilhar_publicacao.php?codigo_news=<?php print($vetor_news['codigo']); ?> && cod_usuario_post=<?php print($vetor_news['usuario']); ?>">
