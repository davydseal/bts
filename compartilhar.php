...
$select = "SELECT * FROM $table_compartilhados WHERE id_post=$codigo_news && id_usuario_compartilhado=$id_usuario ";
...
$inserir = "INSERT INTO $table_compartilhados(id_post,id_compartilhador, descricao, data, hora, id_usuario_compartilhado) VALUES ($codigo_news,$cod_login, '$c_descricao', '$data', '$hora', '$id_usuario')";
$resultado_inserir = mysqli_query($mysqli, $inserir);

$atualizar = "UPDATE $table_post  SET compartilhamentos = compartilhamentos +1 WHERE codigo=$codigo_news";
