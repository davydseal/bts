                                        ...
                                        <li>
                                            <div class="profile-box friend-box">
                                                <div class="profile-content">
                                                    ...
                                                    <div class="profile-detail">
                                                          <a href="ver_usuario_adm.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"><h2><?php print($vetor_amigo2[1]); ?> <?php print($vetor_amigo2[2]); ?> <span>❤</span></h2></a>
                                                        <h5><?php print($vetor_amigo2[7]); ?></h5>
                                                        <div class="counter-stats">
                                                            <ul>
                                                                <li>
                                                                    <h3 class="counter-value"><?php print($quantidade_seguindo); ?></h3>
