                        ...
                        <div class="tab-section">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" data-bs-toggle="pill" href="#privacy" role="tab"
                                    aria-controls="privacy" aria-selected="false">privacidade</a>
...
<?php
 require("ligar.php");
            ...
            ?>
                                        ...
                                        <form class="theme-form form-sm" method="post" action="configuracao2.php">
                                            <div class="row">
            ...
            ?>
                        ...
                        <div class="tab-pane fade" id="privacy" role="tabpanel">
                            <div class="setting-wrapper">
                                ...
                                <div class="form-sec">
                                    <div>
                                        <form method="post" action="privacidade.php" class="theme-form form-sm">
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    <label>quem pode ver seus posts?</label>
                                                    <select name="c_posts" class="form-control">
                                                        <?php
...
?>
      ...
      <option value="2">Ninguém</option>
      <?php
}
 else if($vetor['posts'] == '2')
{
?>

      <option value="2" checked>Ninguém</option>
...
<?php
 ...
 ?>
                                                ...
                                                <div class="form-group col-12">
                                                    <label>quem pode ver suas fotos?</label>
                                                    <select name="c_fotos" class="form-control">
                                                      <?php
...
<?php
 ...
 ?>
                                                ...
                                                <div class="form-group col-12">
                                                    <label>quem pode ver seus videos?</label>
                                                    <select name="c_videos" class="form-control">
                                                        <?php
...
<?php
 ...
 ?>
                                                ...
                                                <div class="form-group col-12">
                                                    <label>quem pode ver seu email?</label>
