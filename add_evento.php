                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="add_evento2.php" enctype="multipart/form-data" class="c-form">

 

                     <tr>
                        
                        <td> <input type="text" name="c_nome" style="width:1000px;" placeholder="Nome!" class="form-control"></td><br>
                  ...
                  <tr>
                        ...
                        <td> <textarea cols="53" name="c_descricao" placeholder="Descrição!" rows="6" class="form-control"></textarea></td><br>

                    </tr>
                     <tr>
                        
                        <td>   <textarea cols="53" name="c_regras" placeholder="Regras!" rows="10" class="form-control"></textarea></td><br>

                    </tr>
                         <tr>
                        
                        <td>    <textarea cols="53" name="c_premiacao" placeholder="Premiação!" rows="4" class="form-control"></textarea></td><br>

                    </tr>

                     <tr>
                        
                        <td>     <input type="text" placeholder="Início, Ex: dd/mm/aaaa" id="outra_data" maxlength="10" onkeypress="mascaraData(this)" name="c_datain" class="form-control"></td><br>

                    </tr>

                     <tr>
                        
                        <td>    <input type="text" placeholder="Fim, Ex: dd/mm/aaaa" id="outra_data" maxlength="10" onkeypress="mascaraData(this)"s name="c_datafim" class="form-control"><br>
