...
require("ligar.php");
$delete = "DELETE FROM $table_comentario_video where codigo=$codigo_news && usuario=$cod_login || codigo=$codigo_news && cod_usuario_post=$cod_login";
$atualizar = "UPDATE $table_video  SET comentarios = comentarios -1 WHERE codigo=$codigo_post";
