...
?>
 ...
 <?php
             require("ligar.php");
            $consulta3 = "SELECT * FROM $table_generos_musicais WHERE status=1 order by genero ASC";
                                                ...
                                                <div class="profile-content">
                                                    <div class="image-section">
                                                        <div class="profile-img">
                                                            <div>
                                                                <img src="generos_musicais/<?php print($variavel['img']); ?>"
                                                    ...
                                                    <div class="profile-detail">
                                                         <h2><?php print($variavel['genero']); ?> <span>❤</span></h2>
                                                      
                                                        <a href="add_genero.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-outline">Adicionar
                                                            </a>
                                                    </div>
                                                </div>
                                            </div>
