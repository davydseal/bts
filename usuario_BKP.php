...
$vetor_banda = mysqli_fetch_array($resultado_banda);
 ...
 ?> 
            ...
            <br><br>
            <center><input type="submit" name="submit" value="Publicar" class="btn btn-primary"></center>
            ...
            ?>
                         ...
                         <div class="post-wrapper col-grid-box section-t-space">
                                <div class="post-title">
                                    <div class="profile">
                                        <div class="media">
                                            <a class="popover-cls user-img" data-bs-toggle="popover"  href="ver_usuario.php?codigo_news=<?php print($vetor_amigo['codigo']); ?>"
                                ...
                                <div class="post-details">
                                     <a href="ver_publicacao.php?codigo_news=<?php print($vetor_contatos['codigo']); ?> && cod_usuario_post=<?php print($vetor_contatos['usuario']); ?>"><div class="img-wrapper">
