...
<form method="post" action="ver_fotos2.php" enctype="multipart/form-data">
                        <input type="text"class="form-control" name="c_descricao"
                                                    placeholder="Legenda.."><br>
                                                    ...
                                                    <div class="portfolio-image">
                                                        ...
                                                        <div class="settings">
                                                            <div class="setting-btn setting-dropdown">
                                                                <div
                                                                    class=" btn-group custom-dropdown arrow-none dropdown-sm">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul>
                                                                            <li>
                                                                                <a href="excluir_foto.php?codigo_news=<?php print($variavel['codigo']); ?>"><i
                                                                                        class="icon-font-light iw-16 ih-16"
                                                                                        data-feather="trash-2"></i>Excluir Foto
                                                                                    </a>
                                                                            </li>
