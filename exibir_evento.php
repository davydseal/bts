...
<!-- Mirrored from themes.pixelstrap.com/friendbook/html/page-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Sep 2021 17:10:01 GMT -->
<head>
...
?>
    ...
    <!-- page body start -->
    <div class="page-body container-fluid custom-padding event-page">
                        ...
                        <div class="page-list-section section-t-space">
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="list-box create-page">
                                        <div>
                                             <a href="add_evento.php"><i class="iw-30 ih-30" data-feather="plus-circle"></i></a>
 ...
 <?php
             require("ligar.php");
            $consulta3 = "SELECT * FROM $table_evento";
            ...
            ?>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="list-box">
                                        <div class="cover-img">
                                            <img src="evento/<?php print($variavel['img']); ?>"
                                        ...
                                        <div class="list-content">
                                            ...
                                            <div class="bottom-btn">
                                                <a href="editar_evento.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Editar</a>
                                                <a href="excluir_evento.php?codigo_news=<?php print($variavel['codigo']); ?>" class="btn btn-solid">Excluir</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from themes.pixelstrap.com/friendbook/html/page-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Sep 2021 17:10:07 GMT -->
</html>