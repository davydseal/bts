                        ...
                        <div class="friend-list-box section-b-space">
                            ...
                            <div class="container-fluid">
                                <div class="friend-list friend-page-list">
                                    <ul>
<table align="center">
    <form method="post" action="feedback2.php" class="c-form">

 
<tr>
    <td>
                        <select class="form-control" style="width:700px;" name="c_feed">
                            <option value="">Selecione</option>
                           
                            
                            <option value="Sugestão">Sugestão de melhorias</option>
                            <option value="Reportar">Reportar bug</option>
                  ...
                  <tr>
                        ...
                        <td><textarea rows="10" size="50" class="form-control" name="c_texto" placeholder="Escreva!"></textarea></td><br>
